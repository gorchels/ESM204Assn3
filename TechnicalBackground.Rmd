...
```{r, results='asis'}
survey_table = stargazer(survey_mod, notes.append = FALSE, type = "html", covariate.labels = c("Gender", "Age", "Constant"),
...
bid_mean = (0.7-survey_mod$coefficients[1] - survey_mod$coefficients[2]*0.6 -survey_mod$coefficients[4]-survey_mod$coefficients[11] - survey_mod$coefficients[8]*mean(survey_2$NEP))/survey_mod$coefficients[3]
